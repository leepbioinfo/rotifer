...
Rotifer::DBIC::AnnotationDB::Writer::arch - search for architectures 
...
=head1 SYNOPSIS
  ...
  rannotationDB -of arch -if gi -noload 123456

  # Creating a new writer
  use Rotifer::DBIC::AnnotationDB::Writer;
  my $parser = Rotifer::DBIC::AnnotationDB::Writer->create("arch");
  $parser->write(@ARGV);
...
any domain architectures found in a tabular format identical to the one
generated by domain2architecture.
...
package Rotifer::DBIC::AnnotationDB::Writer::arch;
...
=head2 columns
 ...
 Usage   : Rotifer::DBIC::AnnotationDB::Writer
             ->new(columns => [ "ID", "architecture" ]);
 Function: list of columns to print 
...
sub search_architectures {
	...
	my $attr = {
	    ...
	    order_by => [qw/me.biosequence_id me.biodata_id/],
	    distinct => 1,
	};
