use utf8;
package Rotifer::DBIC::AnnotationDB::Result::BiodataRelationshipDataset;
...
=head1 TABLE: C<biodata_relationship_dataset>

=cut

__PACKAGE__->table("biodata_relationship_dataset");
...
__PACKAGE__->set_primary_key("biodata_relationship_id", "dataset_id");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:i4VCUPZKf5SSZkQj9fCqUQ
